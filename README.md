...
* Sometimes you will need to refresh a page to get it to load, even after editing.  This is normal and is a quirk with this version of CivetWeb server.  If you want to use php's server read instructions in the server->server - local only folder.
