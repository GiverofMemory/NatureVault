...
$FTimeFmt='@@[-**%e %b %Y %R UTC**-]@@';     # logical-scale short: similar to wikipedia (example: 26 Jan 2007 00:29 UTC)
$TimeFmt='%e %b %Y %R UTC'; # used for attachlist in scripts->upload.php function fmtuploadlist
